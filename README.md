...
| **Google Pay**                                                                                                                |                                       |                                                            |
| [Google Pay payment or preauthorization](en:girocheckout:googlepay:start#initializing_a_google_pay_payment "wikilink") | googlePayTransaction                  | GiroCheckout\_SDK\_GooglePayTransaction()                  |
| [Google Pay capture](en:girocheckout:googlepay:start#booking_capture "wikilink")                                                 | googlePayCapture                      | GiroCheckout\_SDK\_GooglePayCapture()                      |
| [Google Pay refund](en:girocheckout:googlepay:start#refund_refund "wikilink")                                                    | googlePayRefund                       | GiroCheckout\_SDK\_GooglePayRefund()                       |
| [Google Pay reversal/void](en:girocheckout:googlepay:start#cancellation_void "wikilink")                                         | googlePayVoid                         | GiroCheckout\_SDK\_GooglePayVoid()                         |
| **WERO**                                                                                                                      |                                       |                                                            |

...
/**
 * Provides configuration for a Google Pay VOID API call.
 *
 * @package GiroCheckout
 */

class GiroCheckout_SDK_GooglePayVoid extends GiroCheckout_SDK_AbstractApi implements GiroCheckout_SDK_InterfaceApi {

    protected $m_iPayMethod = GiroCheckout_SDK_Config::FTG_SERVICES_PAYMENT_METHOD_GOOGLE_PAY;
    protected $m_strTransType = GiroCheckout_SDK_TransactionType_helper::TRANS_TYPE_GOOGLE_PAY_VOID;

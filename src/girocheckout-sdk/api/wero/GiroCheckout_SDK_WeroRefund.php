...
/**
 * Provides configuration for a WERO refund API call.
 *
 * @package GiroCheckout
 */
class GiroCheckout_SDK_WeroRefund extends GiroCheckout_SDK_AbstractApi implements GiroCheckout_SDK_InterfaceApi
{

  protected $m_iPayMethod = GiroCheckout_SDK_Config::FTG_SERVICES_PAYMENT_METHOD_WERO;
  protected $m_strTransType = GiroCheckout_SDK_TransactionType_helper::TRANS_TYPE_WERO_REFUND;

...
/**
 * Sample code for GiroCheckout integration of a paydirekt capture transaction
 *
 * Call through web server in two steps:
 * 1) Without arguments for initial AUTH transaction: http://localhost/PaydirektCapture.php, copy displayed reference
 * 2) With reference code from AUTH for CAPTURE, parameter mode=cap (for capture), parameter ref for reference: 
 * http://localhost/PaydirektCapture.php?mode=cap&ref=43290-48329043-43289
 * 
 * @filesource
 * @package Samples

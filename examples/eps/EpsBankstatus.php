<?php
/**
 * sample code for GiroCheckout integration of a eps bankstatus
 *
 * @filesource
 * @package Samples
...
try {
	$request = new GiroCheckout_SDK_Request(GiroCheckout_SDK_TransactionType_helper::TRANS_TYPE_EPS_BANKSTATUS );

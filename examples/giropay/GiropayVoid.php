...
/**
 * Sample code for GiroCheckout integration of a giropay void transaction
 *
 * Call through web server in two steps:
 * 1) Without arguments for initial AUTH transaction: http://localhost/GiropayVoid.php, copy displayed reference
 * 2) With reference code from AUTH for VOID, parameter mode=void, parameter ref for reference:
 * http://localhost/GiropayVoid.php?mode=void&ref=8a90e166-622b-4a4e-b05c-bd441ce9e655
 ...
 *
 * Remember that you can only void a transaction that has been authorized but not yet captured.
 *
 * @filesource
 * @package Samples
...
//$strReference = "8a90e166-622b-4a4e-b05c-bd441ce9e655";
...
elseif( $mode == "void" ) {
  ...
  try {
    $request = new GiroCheckout_SDK_Request( GiroCheckout_SDK_TransactionType_helper::TRANS_TYPE_GIROPAY_VOID );
    $request->setSecret($projectPassword);

...
/**
 * Sample code for GiroCheckout integration of a giropay senderinfo call.
 *
 * @filesource
 * @package Samples
 * @version $Revision: 337 $ / $Date: 2021-09-23 16:49:49 -0300 (Thu, 23 Sep 2021) $
 */
...
try {
	$request = new GiroCheckout_SDK_Request( GiroCheckout_SDK_TransactionType_helper::TRANS_TYPE_GIROPAY_SENDERINFO );

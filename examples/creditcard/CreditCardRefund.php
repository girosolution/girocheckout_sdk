 ...
 * 1) Without arguments for initial SALE transaction: http://localhost/CreditCardRefund.php, copy displayed reference
 * 2) With reference code from SALE for REFUND, parameter mode=ref (for refund), parameter ref for reference: 
 * http://localhost/CreditCardRefund.php?mode=ref&ref=43290-48329043-43289
 * 
 * @filesource
 * @package Samples

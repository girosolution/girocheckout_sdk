...
/**
 * Sample code for GiroCheckout integration of a credit card senderinfo call.
 *
 * @filesource
 * @package Samples
...
/* creditcard senderinfo and parameters */
try {
	$request = new GiroCheckout_SDK_Request( GiroCheckout_SDK_TransactionType_helper::TRANS_TYPE_CREDITCARD_SENDERINFO );
  ...
  if($request->requestHasSucceeded()) {
    ...
    $request->getResponseParam('expdate');
    $request->getResponseParam('pan');
    $request->getResponseParam('brand');
	}

...
/**
 * Sample code for GiroCheckout integration of a klarna capture
 *
 * @filesource
 * @package Samples
...
/**
 * Specify reference number of the preauthorization transaction to be captured
 */
$strReference = "123ce61b-6f65-43ed-81e7-22283f05c78f";

/* Basket is optional for capture */
$basket = [
    ...
    "basket_items" => [ // List of items in the basket
        [
            ...
            "quantity" => [
                "quantity_amount" => 2, // Amount of units
...
try {
  $request = new GiroCheckout_SDK_Request( GiroCheckout_SDK_TransactionType_helper::TRANS_TYPE_KLARNA_CAPTURE );
  ...
  $request->addParam('merchantId',$merchantID)
          ...
          ->addParam('purpose','Klarna Capture ' . random_int(100,999))

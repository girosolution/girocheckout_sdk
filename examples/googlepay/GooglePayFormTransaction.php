...
$basket = [
    ...
    "basket_items" => [ // List of items in the basket
        [
            ...
            "unit_price" => [
                "net" => 100, // Amount excluding tax (minor unit)
                "gross" => 100, // Amount including tax (minor unit)
...
try {
	$request = new GiroCheckout_SDK_Request( GiroCheckout_SDK_TransactionType_helper::TRANS_TYPE_GOOGLE_PAY_FORM_TRANSACTION);
	$request->setSecret($projectPassword);
	$request->addParam('merchantId',$merchantID)
	        ->addParam('projectId',$projectID)
	        ->addParam('merchantTxId',234324324)
	        ->addParam('amount',100)
	        ->addParam('currency','EUR')
	        ->addParam('purpose','Beispieltransaktion')
	        //->addParam('type','SALE')
	        ->addParam('type','AUTH')
	        ->addParam('urlRedirect','https://www.my-domain.de/girocheckout/redirect-googlepay')
	        ->addParam('urlNotify','https://www.my-domain.de/girocheckout/redirect-googlepay')
